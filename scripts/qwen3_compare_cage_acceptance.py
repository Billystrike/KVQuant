...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compare two fresh Qwen3 CAGE-partition acceptance runs")
...
def main() -> None:
    ...
    if not isinstance(case_ids, list) or len(case_ids) != 11:
        raise Qwen3FormalError("acceptance run lock must contain 11 case IDs")
